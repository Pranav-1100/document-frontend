      ...
      <form onSubmit={handleSubmit} className="bg-surface p-8 rounded-lg shadow-lg">
        <div className="mb-4">
          ...
          <input
            id="title"
            type="text"
            className="w-full px-3 py-2 rounded-md bg-background border border-gray-700 focus:outline-none focus:border-accent"
        ...
        <div className="mb-6">
          ...
          <textarea
            id="content"
            className="w-full px-3 py-2 rounded-md bg-background border border-gray-700 focus:outline-none focus:border-accent h-64"
